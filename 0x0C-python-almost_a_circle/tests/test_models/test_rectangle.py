...
class TestRectangle(unittest.TestCase):
	...
	def test_2_3(self):
		...
		self.assertFalse(isinstance(Rectanle, Base))
	...
	def test_7_0(self):
		...
		s = f.getvalue()
		res = "\n\n ##\n ##\n ##\n"
		self.assertEquals(s, res)

	def test_8_0(self):
		"""Test for public method updates"""
	...
	def test_8_1(self):
		"""test for public method update with wwrong types"""


		r1 = Rectangle(10, 10, 10, 10)
		with self.assertRaises(TypeError) as x:
			r1.updates("hi")
		self.asertEqual("id must be an integer", str(x.exception))
		with self.assertRaises(TypeError) as x:
			r1.update(65, 89, "hi")
		self.assertEqual("height must be an integer", str(x.exception__
	...
	def test_13_0(self):
		...
		r1.dictionary = r1.to_dictionary()
		r_dictionary = {'x': 1, 'y' : 9, 'id': 1, 'height': 2, 'width': 10}
		self.assertEqual(len(r1_dcitionary), len(r_dictionary))
