...
class TestSquare(unittest.TestCase):
	...
	def test_10_1(self):
		...
		s1 =  Square(9, 4, 5, 6)
		self.assertEqual(str(s1), "[Sqaure] (6) 4/5 - 9")
	...
	def test_10_4(self):
		"""Test Sqaure for methods inherited from Rectangle"""
	...
	def test_11_0(self):
		"""Test Square class: check for size attributes"""
	...
	def test_14_1(self):
		"""Test for public method to_dcictionary with wrong args."""
		
		s = "to_dictionary() takes 1 positional arguments but 2 were given"
		with self.assertRaises(TypeError) as x:
			s1 = Square(10, 2, 1, 9)
			s1_dictionary = s1.to_dictionary("Hi")
		self.asserEqual(s, str(x.exception))
